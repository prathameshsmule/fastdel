         ...
         <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
               <div class="container">
                  ...
                  <a class="navbar-brand" href="index.php"> <h4 style="color:white">FastDel</h4> </a>
               ...
               <div class="container">
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        ...
                        <hr>
                        <img src="https://cdn.vox-cdn.com/thumbor/aNM9cSJCkTc4-RK1avHURrKBOjU=/1400x1400/filters:format(jpeg)/cdn.vox-cdn.com/uploads/chorus_asset/file/20059022/shutterstock_1435374326.jpg" alt="" class="img-fluid">
                        <p>Frequently Asked?</p>
                        <div class="panel">
                           <div class="panel-heading">
                              <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle collapsed" href="#faq1" aria-expanded="false"><i class="ti-info-alt" aria-hidden="true"></i>What is FastDel Customer Care Number?</a></h4>
                           </div>
                    ...
                    <div class="row text-img-block text-xs-left">
                        <div class="container">
                            ...
                            <div class="col-xs-12 col-sm-7 left-text">
                                <h3>FastDel - The Best Food Delivery App</h3>
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <h4 style="color:white">fastdel</h4> </a> <span>Choose it &amp; Enjoy your meals! </span> </div>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            <h5>Address:</h5>
                            <p>Deccan FC road, Pune - 600034.</p>
                            <h5>Call us at: <a href="tel:+914450005500">+91 9561434028</a></h5></div>
